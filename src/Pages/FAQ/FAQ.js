    ...
    return (
      <div className="relative bg-main min-h-screen flex items-center">
        <div className="py-16 mx-auto w-full md:px-24 px-5 sm:10 md:14 lg:px-28 lg:py-20">
          ...
          <div className="cursor-pointer mb-3 flex flex-col py-10 font-barlow  justify-between text-center overflow-hidden transition-shadow duration-200 bg-white rounded-xl shadow-xl shadow-blue-900 group hover:shadow-2xl hover:bg-gradient-to-b from-[#6a11cb] to-[#2575fc] hover:shadow-blue-400 hover:border hover:text-white text-main">
